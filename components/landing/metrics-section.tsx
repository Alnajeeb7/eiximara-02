...
function AnimatedCounter({ end, suffix = "", prefix = "" }: { end: number; suffix?: string; prefix?: string }) {
  ...
  return (
    <div ref={ref} className="text-6xl lg:text-8xl font-display font-bold tracking-tight text-gradient">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-border rounded-xl overflow-hidden">
          {metrics.map((metric, index) => (
            <div
              key={metric.label}
              className={`bg-card p-8 lg:p-12 transition-all duration-700 ${
